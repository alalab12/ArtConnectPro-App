...
public class InMemoryWorkshopService implements WorkshopService {
    ...
    @Override
    public void createWorkshop(Workshop workshop) { workshops.put(workshop.getTitle(), workshop); }

    @Override
    public void updateWorkshop(Workshop workshop) { workshops.put(workshop.getTitle(), workshop); }

    @Override
    public void deleteWorkshop(String title) { workshops.remove(title); }
}
