...
public class InMemoryGalleryService implements GalleryService {
    ...
    @Override
    public void createGallery(Gallery gallery) { galleries.put(gallery.getName(), gallery); }

    @Override
    public void updateGallery(Gallery gallery) { galleries.put(gallery.getName(), gallery); }

    @Override
    public void deleteGallery(String name) { galleries.remove(name); }
}
