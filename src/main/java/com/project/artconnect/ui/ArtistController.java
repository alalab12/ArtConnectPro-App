...
public class ArtistController {
    ...
    @FXML public void initialize() {
        ...
        artistTable.setRowFactory(tv -> new TableRow<Artist>() {
        ...
        artistTable.getSelectionModel().selectedItemProperty().addListener((o, ov, nv) -> artistTable.refresh());

        if (detailPane != null) {
            DropShadow shadow = new DropShadow(8, 2, 2, Color.gray(0.3));
            detailPane.setEffect(shadow);
        }
