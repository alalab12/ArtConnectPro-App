...
public class CommunityController {
    ...
    @FXML public void initialize() {
        ...
        membershipColumn.setCellFactory(col -> new TableCell<>() {
            @Override protected void updateItem(String v, boolean empty) {
                ...
                setStyle("Premium".equalsIgnoreCase(v)
                        ...
                        : "-fx-text-fill:#7c2d2d;-fx-font-weight:bold;");
            }
        });

        memberTable.setRowFactory(tv -> new TableRow<CommunityMember>() {
        ...
        memberTable.getSelectionModel().selectedItemProperty().addListener((o, ov, nv) -> memberTable.refresh());
    ...
    @FXML public void handleTableClick() {
        ...
        List<String> reviews = communityService.getReviewsByMember(m).stream()
                .map(r -> "★".repeat(r.getRating()) + "  "
                        + (r.getExhibition() != null ? r.getExhibition().getTitle() : "—")
