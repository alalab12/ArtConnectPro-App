...
public class ArtworkController {
    ...
    @FXML public void initialize() {
        ...
        artworkTable.setRowFactory(tv -> new TableRow<Artwork>() {
            @Override protected void updateItem(Artwork item, boolean empty) {
        ...
        artworkTable.getSelectionModel().selectedItemProperty().addListener((o, ov, nv) -> artworkTable.refresh());
